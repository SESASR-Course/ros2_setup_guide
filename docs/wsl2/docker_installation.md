...
![Docker Desktop Settings](/docs/wsl2/images/docker-starting.png)

- Ensure that "Use the WSL 2 based engine" is checked in Settings > General, if not, check it and click Apply & Restart.

![Docker Desktop Settings](/docs/wsl2/images/check_wsl2_bk.png)
...
![Docker Desktop Settings](/docs/wsl2/images/wsl_integration.png)
...
![Docker Desktop Settings](/docs/wsl2/images/docker_version.png)
...
![Docker Desktop Settings](/docs/wsl2/images/docker_hello_world.png)
...
![Docker Desktop Settings](/docs/wsl2/images/docker_gpu_benchmark.png)
